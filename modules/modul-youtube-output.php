 ...
 * --------------------------------------------------------------------
 *
 * Modul-Output: Lytebox Youtube Video
 *
 * --------------------------------------------------------------------
 */

$youtube_url = "REX_VALUE[1]";

$breite_media = "REX_VALUE[2]" == "" ? "800" : trim("REX_VALUE[2]");
$hoehe_media = "REX_VALUE[3]" == "" ? "600" : trim("REX_VALUE[3]");
$breite_vorschau = "REX_VALUE[4]" == "" ? "200" : trim("REX_VALUE[4]");
$hoehe_vorschau = "150";

// Vorschaubild berechnen
$vorschaubild = OOMedia::getMediaByName(trim("REX_MEDIA[1]"));
...
print '<a class="lytebox" data-lyte-options="width:'.
		$breite_media .'px height:'. $hoehe_media .'px" href="'. $youtube_url . '" >';
if($vorschaubild instanceof OOMedia) {
